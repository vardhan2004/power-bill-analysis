          ...
          <ul className="metismenu list-unstyled" id="side-menu">
            ...
            <li>
              ...
              <ul className="sub-menu">
                ...
                <li><Link to="/dashboard2">{props.t("Dashboard")} </Link></li>
                </ul>
            </li>
            <li>
            <Link to="/tables-monthreport" className="waves-effect">
                <i className="mdi mdi-chart-line"></i>
                <span className="badge rounded-pill bg-info float-end"></span>
                <span>{props.t("MonthReport")}</span>
              </Link>
            </li>
            <li>
            <Link to="/tables-yearreport" className="waves-effect">
                <i className="mdi mdi-chart-bar"></i>
                <span className="badge rounded-pill bg-info float-end"></span>
                <span>{props.t("YearReport")}</span>
              </Link>
            </li>
            ...
            <li>
              {/* <Link to="/#" className="waves-effect">
                ...
                <span> <Link to="/basic-elements">{props.t("Enter Readings")}</Link></span>
              </Link> */}
              {/* <ul className="sub-menu"> */}
                {/* <li> */}
                <Link to="/basic-elements" className=" waves-effect">
                <i className="mdi mdi-pencil"></i>
                <span>{props.t("Enter Reading")}</span>
              </Link>
